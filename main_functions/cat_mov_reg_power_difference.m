function [CLIM, ix_subject_scan,MU,SIGMA,P]=cat_mov_reg_power_difference(path_filename_mov_reg_file,TR,varargin)
...
min_frames=min(frames)-1;% to compensate dor the diff
